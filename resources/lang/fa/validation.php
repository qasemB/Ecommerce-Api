...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'data.email'                          => 'ایمیل',
        'categoryToEdit.title'                          => 'عنوان',
        'params.gallery_category_id'                => 'دسته',
        'params.top_title'                          => 'عنوان',
        'params.h_title'                            => 'تایتل',
        'params.date'                               => 'تاریخ',
        'params.location'                           => 'مکان',
        'params.description'                        => 'توضیحات',
        'params.alt_image'                          => 'توضیح تصویر',
        'params.keywords'                           => 'کلمات کلیدی',
        'images.*'                           => 'تصاویر',
        'qAnswer'                           => 'پاسخ سوال',
        'c_password'                           => 'تایید پسورد',
